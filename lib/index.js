...
function Card(props) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames(s.container, mobile && s.mobile, s["container-".concat(type)], className) }, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames(s.title, s["title-".concat(type)]) }, { children: [jsxRuntime.jsx("h4", __assign({ className: s.titleText }, { children: type !== 'compact' && title ? title : '' })), onRequestClose && (jsxRuntime.jsx("button", { className: classNames(s.icon, s["icon-".concat(type)]), onClick: onRequestClose }))] })), jsxRuntime.jsx("div", __assign({ className: "h-full" }, { children: children }))] })));
}

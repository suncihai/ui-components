...
var DefaultAvatar = function (props) {
    var size = props.size;
    return (jsxRuntime.jsxs("svg", __assign({ width: size, height: size, viewBox: "0 0 50 50", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props, { children: [jsxRuntime.jsx("circle", { cx: "25", cy: "25", r: "25", fill: "#E5E5EA" }), jsxRuntime.jsx("path", { d: "M30.4484 16.0208C30.4484 18.9088 28.0691 21.2746 25.1036 21.2746C22.1381 21.2746 19.7588 18.9088 19.7588 16.0208C19.7588 13.1328 22.1381 10.767 25.1036 10.767C28.0691 10.767 30.4484 13.1328 30.4484 16.0208Z", stroke: "white", "stroke-width": "2", "stroke-linecap": "round" }), jsxRuntime.jsx("path", { d: "M11.2388 36.7454C12.9685 30.8582 18.4789 26.5541 25.0093 26.5541C31.5396 26.5541 37.0501 30.8582 38.7798 36.7454", stroke: "white", "stroke-width": "2", "stroke-linecap": "round" })] })));
};
...
var css_248z$4 = ".Avatar-module_avatarContainer__dMpZG {\n  border-color: var(--grey-2);\n}\n  .Avatar-module_avatarContainer__dMpZG.Avatar-module_default__omRXt {\n    border: none;\n  }\n";
var s$4 = {"avatarContainer":"Avatar-module_avatarContainer__dMpZG border rounded-full bg-cover bg-no-repeat","default":"Avatar-module_default__omRXt"};
...
var Button = function (props) {
    ...
    var className = classNames(s$3.button, s$3[size], s$3[style], disabled && s$3.disabled, props.className, icon && s$3.icon, smIcon && s$3.smIcon, rounded && s$3.rounded);
...
var s = {"premiumRoomButton":"PremiumRoomButton-module_premiumRoomButton__Xrj6W inline-flex gap-x-2 max-w-[200px]","icon":"PremiumRoomButton-module_icon__nFCuv"};

...
function Card(props) {
    ...
    return (jsxs("div", __assign({ className: classNames(s.container, s["container-".concat(type)], className) }, { children: [jsx("div", __assign({ className: classNames(s.title, s["title-".concat(type)]) }, { children: jsx("h4", __assign({ className: s.titleText }, { children: type !== 'compact' && title ? title : '' })) })), jsx("div", __assign({ className: "h-full" }, { children: children }))] })));
}

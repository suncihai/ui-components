...
function Card(props) {
    ...
    return (jsxs("div", __assign({ className: classNames(s.container, mobile && s.mobile, s["container-".concat(type)], className) }, { children: [jsxs("div", __assign({ className: classNames(s.title, s["title-".concat(type)]) }, { children: [jsx("h4", __assign({ className: s.titleText }, { children: type !== 'compact' && title ? title : '' })), onRequestClose && (jsx("button", { className: classNames(s.icon, s["icon-".concat(type)]), onClick: onRequestClose }))] })), jsx("div", __assign({ className: "h-full" }, { children: children }))] })));
}
